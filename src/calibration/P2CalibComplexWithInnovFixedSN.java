...
/** 
 * P2CalibComplexFixedWithInnovSN class
 * 
 ...
 * and then 4 parameters if just one segment (it has the innovation prob. too)
 * 
 ...
 * 
 */
public class P2CalibComplexWithInnovFixedSN extends Parameters2Calib {
	...
	public P2CalibComplexWithInnovFixedSN(int _numParameters2Calib) {
	...
	public void specifyParams (double[] _params){
		...
		for (int k = 0; k < this.getNumSegments(); k++) {
			...
			// innovation prob (obtaining subscription individually)
