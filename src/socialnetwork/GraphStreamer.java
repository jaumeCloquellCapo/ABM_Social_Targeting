...
public class GraphStreamer {
    ...
    /**
     * Set static to true and if it wasn't static before we create a treemap
     * with neighbours!
     *
    ...
    /**
     * with this function we copy the initial network read from a file in order
     * not to have edges removed and added
     *
     * @param params
     */
...
//		genView();
    ...
    /**
     * set a value to the attribute of an edge given by two nodes (it creates it
     * if it doesn't exist)
     *
    ...
    /**
     * set the same value to the attributes of the edges of all the neighbors of
     * the given node (it creates it if it doesn't exist)
     *
    ...
    /**
     * get a value of the attribute of an edge given by two nodes (it creates it
     * if it doesn't exist)
     *
     * @param ind1 - index of the first node.
     * @param ind2 - index of the second node.
     ...
     * @return the id of the target node for the new edge. Return -1 if not
     * created (already has all the possible edges)
     */
    ...
    /**
     * Remove an edge between the source node given by ind and one of its
     * neighbors at random
     *
     * @param ind - index of the node.
    ...
    /**
     * Sets node's color in case of buying a product or changing the company
     * (product).
     *
    ...
    public ArrayList<Node> getDegreeMap() {
        return Toolkit.degreeMap(graph);
    }
